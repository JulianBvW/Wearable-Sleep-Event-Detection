...
Table \todo{table} also shows the detection rate for events in different sleep stages. One can see, that \todo{... is most prevelant ... N3 as protective stage not so much ... best rate in ...}
...
\begin{table}
    ...
    \begin{tabular}{ l p{2cm} p{2cm} p{2cm} p{2cm} }
        & Wake & N1/N2 & N3 & REM \\
        \hline
        Stage \% of all nigths & 25.1\% & 2.0\% & 6.3\%  &  66.7\% \\
        \hline
        ...
        \% found & 70.7\% & 89.4\% & 81.9\% & 68.8\% \\
    \end{tabular}
    \caption{\todo{TBA}. \label{tab:sleep-stage-distribution}}
\end{table}
