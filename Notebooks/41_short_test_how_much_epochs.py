...
runs = [
    ('pleth_pre_stat_vae', 0),
    ('pleth_pre_stat_vae', 1),
    ('pleth_pre_stat_vae', 2),
    ('pleth_pre_stat_vae', 4),
    ('pleth_pre_stat_vae', 8),
    ('pleth_pre_stat_vae', 16),
    ('pleth_pre_stat_vae', 26),
    ('pleth_pre_stat_vae', 38),
...
df.to_csv('Notebooks/41_short_test_how_much_epochs.csv', index=False)