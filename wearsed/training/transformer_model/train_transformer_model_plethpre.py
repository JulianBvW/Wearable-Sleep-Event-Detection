...
from wearsed.models.transformer_model.TransformerModel_PlethPre import TransformerModel
...
parser = ArgumentParser(description='Train code for training the Transformer model')
...
# Output folder
OUTPUT_DIR = f'wearsed/training/transformer_model/output/{args.out_dir}/f-{args.fold_nr}/'
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Dataset
full_dataset = WearSEDDataset(signals_to_read=['SpO2'], pleth_statistical=True, pleth_vae_latents=True)#, use_predicted_hypnogram=args.use_predicted_hypnogram)
