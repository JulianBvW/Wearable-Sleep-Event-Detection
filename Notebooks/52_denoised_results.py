...
runs = [
    ('attention_none', 28, [0]),
    ('denoising_lowpass', 28, [0]),
    ('denoising_bandpass', 28, [0]),
    ('denoising_wavelet_db4', 28, [0]),
    ('denoising_wavelet_dmey', 28, [0]),
    ('denoising_wavelet_haar', 28, [0])
]
...
df.to_csv('Notebooks/52_denoised_results.csv', index=False)