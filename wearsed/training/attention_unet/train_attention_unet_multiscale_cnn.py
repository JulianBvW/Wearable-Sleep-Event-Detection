...
from wearsed.models.attention_unet.AttentionUNet_multiscale_cnn import AttentionUNet
...
model = AttentionUNet(in_channels=10, use_attention=args.use_attention.split(',')).to(device)
